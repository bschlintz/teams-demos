...
export interface IFoodTruckFindrTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IFoodTruckFindrTabRemoveProps extends ITeamsBaseComponentProps {

}

/**
 * Implementation of Food Truck Findr remove page
 */
export class FoodTruckFindrTabRemove  extends TeamsBaseComponent<IFoodTruckFindrTabRemoveProps, IFoodTruckFindrTabRemoveState> {
